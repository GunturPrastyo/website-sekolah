<script setup>
import { ref } from 'vue';
import { PhX, PhWhatsappLogo, PhLink, PhCheckCircle } from '@phosphor-icons/vue';
      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all" @click.stop>
        ...
        <div class="p-6">
          ...
          <div class="flex gap-4 justify-center mb-6">
            ...
            <button class="w-12 h-12 rounded-full bg-green-100 dark:bg-slate-700 text-green-600 dark:text-green-400 flex items-center justify-center hover:bg-green-200 dark:hover:bg-slate-600 transition-colors" title="Bagikan ke WhatsApp"><PhWhatsappLogo class="w-5 h-5" /></button>
            <button @click="copyLink" class="w-12 h-12 rounded-full bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-200 flex items-center justify-center hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors" title="Salin Tautan"><PhLink class="w-5 h-5" /></button>
          </div>
