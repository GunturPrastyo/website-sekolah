      ...
      <div class="container relative z-10 mx-auto px-6 max-w-7xl">
        <div class="relative wrap overflow-hidden p-2 md:p-10 h-full" ref="timelineRef">
          ...
          >
            ...
            <div
              class="absolute top-0 left-0 w-full bg-blue-600 dark:bg-blue-400 rounded-full transition-all duration-200 ease-out"
          ...
          <div
            ...
            :key="index"
            class="fade-on-scroll opacity-0 translate-y-10 scale-95 transition-all duration-700 ease-out relative z-10 flex items-center w-full mb-12 last:mb-0 group"
          ...
          >
            ...
            <div
              class="absolute left-8 md:left-1/2 transform -translate-x-1/2 flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full bg-blue-600 border-4 border-white dark:border-slate-800 text-white shadow-lg z-20 group-hover:scale-110 group-hover:bg-blue-500 transition-all duration-300"
            >
            ...
            >
              <div
                class="group/card bg-white dark:bg-slate-800 p-4 md:p-6 rounded-2xl shadow-md border border-gray-100 dark:border-slate-700 hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-400 relative"
              >
                <div
                  class="hidden md:block absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-white dark:bg-slate-800 border-t border-r border-gray-100 dark:border-slate-700 transform rotate-45 z-0"
                  :class="
                    index % 2 === 0
                      ? '-right-2'
                ...
                <div class="relative z-10 flex flex-col lg:flex-row gap-5 items-stretch">
                  <!-- Gambar Dokumentasi Timeline -->
                  <div
                    class="relative w-full lg:w-5/12 shrink-0 rounded-xl overflow-hidden shadow-sm h-48 lg:h-auto min-h-[180px]"
                  >
                    <img
                      :src="item.image"
                    ...
                    <div class="absolute top-3 left-3">
                      <span
                        class="inline-block px-3 py-1 bg-blue-600/90 backdrop-blur-sm text-white font-bold text-xs md:text-sm rounded-lg shadow-sm border border-white/20"
                        >{{ item.year }}</span
                      >
                    </div>
                  </div>
                  ...
                  <!-- Teks/Deskripsi -->
                  <div class="w-full lg:w-7/12 flex flex-col justify-center py-2">
                    <h3
