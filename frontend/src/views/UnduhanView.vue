...
// Fungsi pembantu untuk menambal URL gambar header jika dikirim berupa path relatif
...
const fetchInitialData = async () => {
  ...
  try {
    ...
    if (settingsResult.success) {
      appearanceSettings.value = settingsResult.data;
    }
  } catch (error) {
    console.error("Gagal mengambil data inisialisasi halaman unduhan:", error);
  } finally {
