...
const colors = [
  {
    ...
    calHeader: "bg-slate-600 dark:bg-slate-700 text-white",
  ...
  },
  {
    id: "guru-staf",
    name: "Guru & Staf",
    bg: "bg-gray-100 text-gray-700 dark:bg-gray-700/50 dark:text-gray-300",
    calBg: "bg-gray-50 dark:bg-gray-700/30 hover:bg-gray-100 dark:hover:bg-gray-700/50",
    calHeader: "bg-gray-600 dark:bg-gray-700 text-white",
  ...
  },
  {
    id: "kegiatan",
    name: "Kegiatan",
    bg: "bg-zinc-100 text-zinc-700 dark:bg-zinc-700/50 dark:text-zinc-300",
    calBg: "bg-zinc-50 dark:bg-zinc-700/30 hover:bg-zinc-100 dark:hover:bg-zinc-700/50",
    calHeader: "bg-zinc-600 dark:bg-zinc-700 text-white",
  ...
  },
  {
    id: "acara",
    name: "Seminar & Acara",
    bg: "bg-neutral-100 text-neutral-700 dark:bg-neutral-700/50 dark:text-neutral-300",
    calBg:
      "bg-neutral-50 dark:bg-neutral-700/30 hover:bg-neutral-100 dark:hover:bg-neutral-700/50",
    calHeader: "bg-neutral-600 dark:bg-neutral-700 text-white",
