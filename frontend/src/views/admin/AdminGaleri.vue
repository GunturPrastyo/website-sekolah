      ...
      >
        ...
        <div class="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-end">
          ...
          <button
            ...
            class="flex-1 sm:flex-none justify-center px-3 py-1.5 border border-gray-300 dark:border-slate-600 rounded-lg text-sm font-semibold hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors text-gray-700 dark:text-gray-300 shadow-sm flex items-center"
          >
            <PhList class="w-4 h-4 mr-1.5" /> Kelola Kategori
          </button>
          <button
            v-if="!isFormVisible"
            @click="showAddForm"
